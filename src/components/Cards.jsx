      ...
      <div className="team-card">
        ...
        <div className="card-front">
          <div className="profile-image-container">
            <img src={image} className="profile-image" alt={name} />
          </div>

          <h2 className="member-name font-orbitron">{name}</h2>
          <p className="member-role font-orbitron">{role}</p>

          <div className="social-icons social-icons-front">
            {instagram && (
            ...
            {formattedWhatsApp && (
              <a href={formattedWhatsApp} target="_blank" rel="noopener noreferrer" className="social-link">
                <svg viewBox="0 0 24 24" className="icon">
