        ...
        <StyledWrapper>
            <div className="nav">
                <div className="container">
                    ...
                    <div className="btn"><Link to="/Events">Events</Link></div>
                    <div className="btn"><Link to="/Accommodation">Accommodation</Link></div>
                    <div className="btn"><Link to="/contact-us">Contact Us</Link></div>
