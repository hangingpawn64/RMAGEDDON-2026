        ...
        <div className="relative h-full flex flex-col gap-4 sm:gap-5 md:gap-6 px-4 sm:px-10 md:px-12 lg:px-16 py-4 sm:py-5 md:py-6 ">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-2 font-bold lg:gap-4 px-4 sm:px-8 py-3 sm:py-4 border-t border-white/20 text-[14px] sm:text-[16px] md:text-[18px] text-white/80 font-saira">
            ...
            <div className="flex-1 text-center lg:text-right">
              <a href="mailto:akshittupkar8@gmail.com" className="text-white/90 underline hover:text-white/80 hover:drop-shadow-[0_0_10px_rgba(255,255,255)] transition-all duration-300">
